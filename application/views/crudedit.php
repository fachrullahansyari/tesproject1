  ...
  <body id="page-top">
    ...
    <section id="services">
      <div class="container">
        ...
        <div class="form-group">
        <input type="hidden" name="id_crud" value="<?php echo $u->id_crud ?>">
        <input class="form-control" id="name" name="nama" type="text" value="<?php echo $u->nama ?>" required data-validation-required-message="Please enter your name.">
        <p class="help-block text-danger"></p>
        </div>
        <div class="form-group">
        <input class="form-control" id="name1" name="nama1" type="text" value="<?php echo $u->nama1 ?>" required data-validation-required-message="Please enter your name.">
        <p class="help-block text-danger"></p>
        </div>
        <div class="form-group">
        <input class="form-control" id="name2" name="nama2" type="text" value="<?php echo $u->nama2 ?>" required data-validation-required-message="Please enter your name.">
        <p class="help-block text-danger"></p>
        </div>
        <div id="success"></div>
