...
<html lang="en">
  ...
  <head>
    ...
    <title>FHRL.CO - Lets Start</title>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
              ...
              <img class="img-fluid" src="<?php echo base_url('asset/img/portfolio/01-thumbnail.jpg')?>" alt="">
            </a>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
              ...
              <img class="img-fluid" src="<?php echo base_url('asset/img/portfolio/02-thumbnail.jpg')?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Explore</h4>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
              ...
              <img class="img-fluid" src="<?php echo base_url('asset/img/portfolio/03-thumbnail.jpg')?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Finish</h4>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal4">
              ...
              <img class="img-fluid" src="<?php echo base_url('asset/img/portfolio/04-thumbnail.jpg')?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Lines</h4>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal5">
              ...
              <img class="img-fluid" src="<?php echo base_url('asset/img/portfolio/05-thumbnail.jpg')?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Southwest</h4>
          ...
          <div class="col-md-4 col-sm-6 portfolio-item">
            <a class="portfolio-link" data-toggle="modal" href="#portfolioModal6">
              ...
              <img class="img-fluid" src="<?php echo base_url('asset/img/portfolio/06-thumbnail.jpg')?>" alt="">
            </a>
            <div class="portfolio-caption">
              <h4>Window</h4>
            ...
            <ul class="timeline">
              <li>
                <div class="timeline-image">
                  <img class="rounded-circle img-fluid" src="<?php echo base_url('asset/img/about/1.jpg')?>" alt="">
                </div>
              ...
              <li class="timeline-inverted">
                <div class="timeline-image">
                  <img class="rounded-circle img-fluid" src="<?php echo base_url('asset/img/about/2.jpg')?>" alt="">
                </div>
                <div class="timeline-panel">
                  <div class="timeline-heading">
                    <h4>March 2011</h4>
        ...
        <div class="row">
          <div class="col-sm-4">
            <div class="team-member">
              <img class="mx-auto rounded-circle" src="<?php echo base_url(); ?>/asset/img/team/1.jpg" alt="">
              <h4>Kay Garland</h4>
